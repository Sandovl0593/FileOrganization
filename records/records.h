...
struct Player{
    ...
    Player(double _id, const char* _name, const char* _birthdate, const char* _school,
        ...
        strncpy(name, _name);
        strncpy(birthdate, _birthdate);
        strncpy(school, _school);
        strncpy(country, _country);
        strncpy(height, _height);
        strncpy(jersey, _jersey);
        strncpy(position, _position);
        strncpy(team_name, _team_name);
        strncpy(team_abbreviation, _team_abbreviation);
        strncpy(team_city, _team_city);
    }
...
struct Game {
    ...
    Game(double _season_id, double _team_id_home, const char* _team_abbreviation_home,
        ...
        strncpy(team_abbreviation_home, _team_abbreviation_home);
        strncpy(team_name_home, _team_name_home);
        strncpy(game_date, _game_date);
        strncpy(matchup_home, _matchup_home);
        strncpy(team_abbreviation_away, _team_abbreviation_away);
        strncpy(team_name_away, _team_name_away);
        strncpy(matchup_away, _matchup_away);
        strncpy(season_type, _season_type);
    }
